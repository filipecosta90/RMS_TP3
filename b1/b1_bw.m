...
l = legend('full bw','flow 0 -> 8 bw ( 3Mb CBR App ) :: Client 1 to Client 6' , 'flow 1 -> 7 bw ( FTP connection ) :: Client 2 to Client 5' , 'flow 2 -> 6 bw ( VOIP connection over UDP ) :: Client 3 to Client 4' );
