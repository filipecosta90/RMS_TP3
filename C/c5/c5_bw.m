...
l = legend('full bw','flow 0 -> 8 bw ( 4Mb CBR App ) :: Client 1 to Client 6' , 'flow 1 -> 6 bw ( 4Mb CBR App ) :: Client 2 to Client 4 ','flow 1 -> 7 bw ( FTP Connection ) :: Client 2 to Client 5' , 'flow 2 -> 6 bw ( VOIP Connection over UDP ) :: Client 3 to Client 4' );
