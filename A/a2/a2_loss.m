...
l = legend('full loss','flow 1 -> 7 #packet loss ( 3Mbps CBR App )  :: Client 2 to Client 5' ,  'flow 2 -> 6 #packet loss ( 3Mbps CBR App )  :: Client 3 to Client 4',  'flow 7 -> 1 #packet loss ( 3Mbps CBR App )  :: Client 5 to Client 2' ,  'flow 8 -> 0 #packet loss ( 3Mbps CBR App )  :: Client 6 to Client 1');
